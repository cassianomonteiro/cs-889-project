...
Shapiro tests show that times for both **block** and **game** follow normal distributions (p>0.1). Let's do a pairwise comparison of time between blocks and games using parametric tests (within-group, 2 levels).
